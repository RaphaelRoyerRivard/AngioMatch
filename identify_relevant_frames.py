...
if __name__ == '__main__':
    ...
    contracted_ground_truth = [
        ...
        31, 30,  # G10
        32, 31,  # G12
        24, 25, 37, 42, 28, 40, 14, 55,  # G13
        31, 32, 32, 27,  # G14
        23, 61, 27, 34, 30, 27,  # G15
        20, 22, 33, 28, 30, 19, 23, 21, 81, 80,  # G16
        31, 22, 48, 31, 43, 20, 19, 68, 82,  # G17
        48, 57, 44, 59, 48, 48, 55, 70, 65,  # G18
        32, 49, 34, 33, 43,  # G2
        28, 28, 28, 35, 26, 26, 30,  # G3
        34, 25, 35, 36, 27, 29, 32, 48,  # G5
        36, 29, 35, 35, 26, 33, 38,  # G6
